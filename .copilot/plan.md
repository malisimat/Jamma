...
An actual VSTi loads ok and accepts MIDI.  Example 64-bit VST2 instrument:
"C:\Users\matto\VST\64bit\Serum_x64.dll"
...
### Out of scope
Tests must not attempt to load an actual VSTi.
