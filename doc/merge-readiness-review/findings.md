...
- B017 review closeout: independent approval `2b76c7c` confirms F-037's exact deletion, replacement coverage, membership/symbol hygiene, and whole-branch diff cleanliness. F-037 is implemented, verified, and independently approved.
