...
| F-033 | B001 static audit at `996bda2a`: guard spans scratch-buffer acquisition through synchronous ingestion; escaping Session/Controller wrappers removed; no new callback allocation/lock/wait/I/O/formatting/final destruction | P9 registered/passed before source movement at `9b46803e`; final P9 + two ingestion tests 3/3, then P9 100/100 repeated controlled stops | Live-server reconnect and ASan/page heap/Application Verifier remain explicit Stage 21 limitations | B001 implementation verified; independent review pending |
...
| F-041 | B001 registered an existing-owner scoped-use seam with no raw-buffer test API; P7/P8 lifecycle surfaces remain B005 | P9 passed alone before production movement and 100/100 under repeated controlled stop; P7/P8 pending B005 | Sanitizer/page heap/Application Verifier plus manual reconnect remain Stage 21/B005 evidence | Buffer-borrow prerequisite closed by B001; lifecycle portion remains B005; independent B001 review pending |
