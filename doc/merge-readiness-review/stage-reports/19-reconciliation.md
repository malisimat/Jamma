...
- **Cleanup backlog owner:** retain one or two closest passing prerequisites per major refactor. The initial architecture work must be gated by P1/P2 and the epoch/map work by P3/P4 as applicable; later publication, recovery, lifetime, and diagnostics work use P5/P6, P7/P8, P9, and P10 narrowly rather than as one umbrella batch (`verification-matrix.md:74`–`:91`).
