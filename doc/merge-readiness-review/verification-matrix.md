...
| F-032 | B002 `e0d60f2d` shares finite/plausible validation at conversion and as the first egress statement; invalid return precedes arithmetic, formatting, strings, lock, four sends, log, and authority mutation | P12 + plausible timing 2/2; placeholder/conversion/fractional-formatting 3/3; invalid/endpoint table includes NaN, infinities, bounds, just-outside, extremes, and invalid BPI | Dynamic send count not instrumented because an approved connection/NJClient seam is absent; malformed manual scenario remains Stage 21 | B002 implemented/verified; independent review pending |
