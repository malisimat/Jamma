...
void QuantisationDivisionModel::AppendPartUvs(std::vector<float>* uvs, float partKind)
{
	if (!uvs)
		return;
...
void QuantisationDivisionModel::AppendQuad(std::vector<float>& verts,
...
void QuantisationDivisionModel::BuildDivisionMesh(std::vector<float>& verts, std::vector<float>& uvs)
{
