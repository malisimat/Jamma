...
- Human decision: accepted ([decision](decisions.md#findings)).
- Phase 4 execution: B001 prerequisite `9b46803ea4bf37f0bb7b3488128da02f1ef4546b` and implementation `996bda2a49de9857f31eb9d9b0f3478f3e28f6da` moved the existing guard through synchronous `StationRemote` ingestion and removed the escaping Session/Controller wrappers. Independent review `b9aed357f8c9cdd2b8149da5dfa9e50efdb8a259` then rejected the separate-atomic guard entry protocol. Corrected P9 overlap coverage landed at `73af93c2229f0073c59a1d2bfa2068daa7e6e74d`; guard correction `5fd1b8062a87e444ccbde35dbccf87bf7f7b2ab8` now increments the use count before its pointer load and orders reader admission, retirement exchange, and count observation sequentially consistently. The callback path is finite and adds no allocation, lock, wait, I/O, formatting, dynamic copy, or final destruction. Corrected P9 passed 640 repeated overlap epochs and both focused ingestion tests passed. Live-server reconnect and ASan/page heap/Application Verifier remain Stage 21 evidence, not claimed here; fresh independent approval remains required.
